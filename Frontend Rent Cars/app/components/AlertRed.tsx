...
interface AlertRedProps {
  message: string;
  onClose: () => void;
}

const AlertRed: React.FC<AlertRedProps> = ({ message, onClose }) => {
  ...
  return (
    <div className={`fixed z-10 inset-0 overflow-y-auto ${isOpen ? '' : 'hidden'}`} id="my-modal">
